...
CREATE TABLE pasajeros (
    BOLNRO INT(6) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT PRIMARY KEY,
    VIANRO CHAR(6) NULL,
...
-- Crear un disparador para actualizar el formato del campo BOLNRO
DELIMITER //
CREATE TRIGGER tr_format_BOLNRO
BEFORE INSERT ON pasajeros
FOR EACH ROW
BEGIN
    SET NEW.BOLNRO = LPAD(NEW.BOLNRO, 6, '0');
END //
DELIMITER ;
